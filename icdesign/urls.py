...
urlpatterns = [
    ...
    path('2022_Task_download', views.download_file_2022_Task_Zip,name = "2022_Task_download"),
    path('2022_exam_seat_download', views.download_file_2022_exam_seat,name="2022_exam_seat_download")
]
